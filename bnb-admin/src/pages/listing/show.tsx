  ...
  return (
    <Show isLoading={isLoading}>
      ...
      <Descriptions bordered column={2} style={{ marginTop: 16 }}>
        ...
        <Descriptions.Item label="Price / Night">₹{record?.price}</Descriptions.Item>
        <Descriptions.Item label="Available">
          {record?.isAvailable ? <Tag color="green">Yes</Tag> : <Tag color="red">No</Tag>}
        </Descriptions.Item>
        <Descriptions.Item label="Rooms">{record?.roomCount}</Descriptions.Item>
        <Descriptions.Item label="Bathrooms">{record?.bathroomCount}</Descriptions.Item>
        <Descriptions.Item label="Max Guests">{record?.guestCount}</Descriptions.Item>
